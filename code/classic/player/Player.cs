...
namespace SpeedDial.Classic.Player {
	public partial class SpeedDialPlayer : BasePlayer {
		...
		public virtual void InitialSpawn() {
			...
			ClassicGamemode.Instance.Round?.OnPlayerSpawn(this);

			if(ClassicGamemode.Instance.Round is PreRound) {
				Freeze = true;
		...
		public override void Respawn() {
			...
			CreateHull();
			ResetInterpolation();
			ClassicGamemode.MoveToSpawn(this);
		}
		...
		public override void Simulate(Client cl) {
			...
			if(!screenOpen && ClassicGamemode.Instance.Round is GameRound) {
