...
namespace SpeedDial.Classic {
	[Skip]
	[Library("sd_classic", Title = "Speed-Dial Classic")]
	public partial class ClassicGamemode : BaseGamemode {
		public ClassicGamemode() : base() {
			PrecacheAssets();
			Instance = this;
		}

		public override void GamemodeInitializeUI() {
			//base.GamemodeInitializeUI();
			_ = new SpeedDialHud();
		}
		...
		public static ClassicGamemode Instance { get; private set; }

		public override void GamemodeDoPlayerSuicide(Client cl) {
		...
		public List<KillFeedEntry> KillFeed = new();


		public override void GamemodeOnKilled(Client client, Entity pawn) {
		...
		public override void GamemodeClientJoined(Client client) {
		...
		public override void GamemodePostLevelLoaded() {
			_ = StartSecondTimer();
		}
		...
		public override void GamemodeDoPlayerNoclip(Client player) {
